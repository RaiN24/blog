...
<html>
    ...
    <h1>我不冷开源博客系统 安装协议</h1>
    <p>序言：我不冷最初只是我的私人博客作品，后来发现大家很喜欢，所以就开源化，我希望每个人都有一个心灵栖息的地方，从工作到感情，心中那份小而美一直存在。</p>
    <p>
    感谢：本套程序使用了ThinkPHP,BootStrap,以及网络上一些插件，在这里感谢ThinkPHP,BootStrap的开源，为本套博客带来了很强大的程序基础，也感谢为我不冷提出建议，提供优化的广大网友，谢谢！
    </p>
    <p>1.我不冷官网网址：<a href="http://www.lcm.wang/">我不冷</a> 作者：MonkeyCode</p>
    <p>2.感谢您选择我不冷，希望我们的努力能为您提供一个简单、强大的博客系统。</p>
    <p>3.如果您对我不冷有BUG提交或者功能建议 可以发送邮件到作者邮箱lcm1475@aliyun.com或者在官网留言</p>
    <p>4.我们希望您在使用过程中可以加入我不冷讨论群分享使用经验（交流群在官网查看）</p>
    <p>5.我不冷是一个开源产品，简单的一句话，懂的都懂，不懂的就不懂</p>
    <p>6.我们希望与大家把我不冷变得更好</p>
    <p>7.用户须知：本协议是您与顶想公司之间关于您使用我不冷产品及服务的法律协议。无论您是个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，包括免除或者限制顶想责任的免责条款及对您的权利限制。请您审阅并接受或不接受本服务条款。如您不同意本服务条款及/或顶想随时对其的修改，您应不使用或主动取消我不冷。否则，您的任何对我不冷的相关服务的注册、登陆、下载、查看等使用行为将被视为您对本服务条款全部的完全接受，包括接受顶想对服务条款随时所做的任何修改。</p>
