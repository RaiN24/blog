...
<!-- 本页导航栏结束 -->
<!-- 正文开始 -->
<div class="zuqiu_left"><span><a href="#"><strong>足球视频</strong></a></span></div>
<div class="text_box2">
    <?php if(is_array($arr)): foreach($arr as $key=>$vo): ?><div class="p_video">
            <div class="img_outer">
            <a href="<?php echo ($vo["url"]); ?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><img src="<?php echo ($vo["img"]); ?>" alt="<?php echo ($vo["title"]); ?>" /><em><?php echo ($video_time); ?></em></a></div>
            <dl><dt><a href="<?php echo ($vo["url"]); ?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></dt>
            <dd>分享: <a href="<?php echo ($vo["author_page"]); ?>" target="_blank"><?php echo ($vo["author"]); ?></a></dd>
