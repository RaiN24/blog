      ...
      <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                ...
                <a href="<?php echo U('Index/index');?>"><i class="fa fa-diamond"></i> <span class="nav-label">后台首页</span> <span class="label label-primary pull-right">NEW</span></a>
                    ...
                    <li>
                        <a href="index.html"><i class="fa fa-th-large"></i> <span class="nav-label">视频管理</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo U('Video/index');?>">查看视频</a></li>
                            <li><a href="<?php echo U('Video/recovery');?>">视频回收站</a></li>
                        </ul>
                    </li>
                    <li>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td><?php echo ($vo["author_page"]); ?></td>
                        <td><img style="width:50px;height:36px" src="<?php echo ($vo["img"]); ?>"></td>
                        <td><?php if($vo["status"] == 1): ?><span class="label label-danger">回收</span><?php else: ?>显示<?php endif; ?></td>
                        <td>
                           <a href="<?php echo U('Video/xianshi',array('id'=>$vo['id']));?>" target="_blank"><button type="button" class="btn btn-w-m btn-info">还原</button></a>
                            <a href="<?php echo U('Video/reallydelete',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>
