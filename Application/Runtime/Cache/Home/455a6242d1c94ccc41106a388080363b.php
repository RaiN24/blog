    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="ibox float-e-margins">
                <form action = "<?php echo U('Message/send');?>"  method="post">
                    ...
                    <div class="form-group has-success"><label class="col-sm-2 control-label">验证码：</label>
                        <div class="col-sm-10"><img src="/tangxiang/index.php/Home/Message/Verify" alt="" onclick="alert('你是想换验证码吗？换不了，数字你还看不清啊？')" style="float:left;"><input class="form-control" type="text" required name = "verify" style="width:auto;"></div>
                    </div>
                    <br><br>
                    <div class="form-group">
