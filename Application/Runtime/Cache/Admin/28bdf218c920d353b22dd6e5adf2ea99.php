            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td><?php if($vo["status"] == 0): ?>未使用<?php else: ?>已使用<?php endif; ?></td>
                        <td><?php echo ($vo["user"]); ?></td>
                        <td>
                            <a href="<?php echo U('Yaoqing/delete',array('id'=>$vo['id']));?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>
