                    ...
                    <div class="ibox-content">
                        <div class="text-center article-title" style="margin:20px 0px 20px">
                            ...
                            <div style="margin-bottom:50px;">
                                <?php switch($fenleiInfo["type"]): case "1": ?><img src="/tangxiang/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>" alt="" style="width:100%"><?php break;?>
                                    <?php case "2": ?><!-- 音乐 -->
                                        <link rel="stylesheet" href="/tangxiang/Public/music/css/lanrenzhijia.css" type="text/css" />
                            ...
                            <script src="/tangxiang/Public/music/js/jquery.min.js"></script>
                            <script src='/tangxiang/Public/music/js/jquery.jplayer.min.js'></script>
                            <script src='/tangxiang/Public/music/js/jplayer.playlist.min.js'></script>
                            <script>
                                $(document).ready(function(){
                                  ...
                                  var playlist = [{
                                      ...
                                      mp3:"/tangxiang/Public/Uploads/<?php echo ($articleInfo["mp3"]); ?>",
                                          //oga:"http://www.jplayer.org/audio/ogg/Miaow-02-Hidden.ogg",
                                          poster: "/tangxiang/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>"
                                      }];
...
<!-- 音乐 --><?php break;?>
<?php case "3": ?><img src="/tangxiang/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>" alt="" style="width:100%"><?php break;?>
<?php default: ?>
<img src="/tangxiang/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>" alt="" style="width:100%"><?php endswitch;?>
...
<div class="col-lg-3">
    <div class="widget-head-color-box navy-bg p-lg text-center" style="margin-top:0px;">
        ...
        <img src="/tangxiang/Public/Uploads/<?php echo ($userInfo["pic"]); ?>" class="img-circle circle-border m-b-md" alt="profile" height="150px;">
    </div>
...
<script>
    ...
    function replay(){
        $.ajax({
         type: "POST",
         url: "/tangxiang/index.php/Home/Article/getReplay",
         data: "id="+id+"&num="+num,
         success: function(msg){
           if(msg == 5){
            ...
            for (var i in msg)
            {
                ...
                if(msg[i].pic ==null){
                    var pic = '/tangxiang/Public/Uploads/default.png';
                }else{
                    var pic = "/tangxiang/Public/Uploads/"+msg[i].pic;
                }
                if(msg[i].uid == userid){
...
<?php if($fenleiInfo["type"] == 4): ?><link href="/tangxiang/Public/wenzixiaoguo/css/animate.css" rel="stylesheet">
    <script src="/tangxiang/Public/wenzixiaoguo/js/jquery.lettering.js"></script>
    <script src="/tangxiang/Public/wenzixiaoguo/js/jquery.textillate.js"></script>
    <script>
        $(function () {
            $('.text2').textillate({
