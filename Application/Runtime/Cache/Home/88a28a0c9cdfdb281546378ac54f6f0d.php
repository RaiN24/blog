            ...
            <?php if($fenleiInfo["type"] == 1): ?><style>
                ...
                <div class="ibox">
                                ...
                                <div class="row">
                                    <div class="col-lg-2" >
                                       <a href="<?php echo U('Article/index',array('id'=>$vo['id']));?>" class="button_link">
                                        <img alt="image" class="img-responsive" src="/tangxiang/Public/Uploads/<?php echo ($vo["pic"]); ?>" style="min-height:120px;">
                    ...
                    <?php elseif($fenleiInfo["type"] == 2): ?>
                        <link rel="stylesheet" type="text/css" href="/tangxiang/Public/doudong/css/type2.css" />
                    <div class = "row">
                                ...
                                <div class="ibox float-e-margins">
                                    <div>
                                        ...
                                        <figure class="effect-layla">
                                            <img alt="image" class="img-responsive" src="/tangxiang/Public/Uploads/<?php echo ($vo["pic"]); ?>" style="width:100%;max-height:300px;">
                                            <figcaption>
                                ...
                                <div class="ibox">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <figure class="effect-goliath">
                                            <a href="<?php echo U('Article/index',array('id'=>$vo['id']));?>"><img alt="member" src="/tangxiang/Public/Uploads/<?php echo ($vo["pic"]); ?>" width="100%"></a>
                    ...
                    <a href="<?php echo U('Article/index',array('id'=>$vo['id']));?>">View more</a>
                        ...
                        <?php elseif($fenleiInfo["type"] == 4): ?>
                            <link rel="stylesheet" type="text/css" href="/tangxiang/Public/doudong/css/tilteffect.css" />
                            <link rel="stylesheet" type="text/css" href="/tangxiang/Public/doudong/css/demo.css" />
                        ...
                        <div class="grid__img grid__img--border">
                            <img src="/tangxiang/Public/Uploads/<?php echo ($vo["pic"]); ?>" class="tilt-effect" data-tilt-options='{ "bgfixed" : false, "movement": { "perspective" : 1000, "translateX" : 30, "translateY" : 30, "translateZ" : -50, "rotateX" : 3, "rotateY" : 3, "rotateZ" : 10 } }' alt="grid01"  width="100%;" />
                        </div>
                    </li>
                    </ul>
                                            </div>
                            ...
                            <script src="/tangxiang/Public/doudong/js/tiltfx.js"></script><?php endif; ?>
                    </div>
