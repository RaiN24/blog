...
<html>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    <h1>创建数据库</h1>
    <form action="/lichengmi/install.php?m=Install&c=Install&a=step2" method="post" target="_self">
        <div class="create-database">
            ...
            <div>
                <input type="text" name="db[]" value="blog_">
        ...
        <div class="create-database">
            ...
            <div>
                ...
                <span>网站口令 别管干什么用的 反正你登陆会用到</span>
            </div>
        </div>
    </form>
