            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td>
                           <a href="<?php echo U('Home/Blog/index',array('id'=>$vo['id']));?>" target="_blank"><button type="button" class="btn btn-w-m btn-warning">查看</button></a>
                            <a href="<?php echo U('User/delete',array('id'=>$vo['id']));?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">禁用</button></a>
                        </td>
