                   ...
                   <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="hr-line-dashed"></div>
                            <form method="post" class="form-horizontal" action="<?php echo U('Adminer/doUpdate');?>" enctype="multipart/form-data">
                                <div class="form-group has-success"><label class="col-sm-4 control-label">输入密码</label>

                                    <div class="col-sm-3"><input type="password" class="form-control" name="pass1" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group has-success"><label class="col-sm-4 control-label">重复密码</label>

                                    <div class="col-sm-3"><input type="password" class="form-control" name="pass2" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-4 control-label">管理员口令</label>
                                    <div class="col-sm-3"><input type="text" class="form-control" name="kouling" required></div>
                                </div>
                               <div class="ibox-content">
                            <div class="text-center">
                            <input type="submit" value="更新" class="btn btn-primary" data-toggle="modal">
                            </div>
